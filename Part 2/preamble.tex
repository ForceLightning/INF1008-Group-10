...
\usetikzlibrary{arrows,calc,shadows.blur,positioning,external,graphs,graphdrawing,bending,fit}
\usegdlibrary{force}
...
\tikzset{
	...
	treenode/.style={
		align=center, inner sep=0pt, text centered, font=\sffamily
	},
	arn/.style={
		treenode, circle, font=\sffamily\bfseries, draw=black, fill=white, text width=4.75ex
	},
	arnrec/.style={
		treenode, rectangle, font=\sffamily\bfseries, draw=black, fill=white,  text width=4.75ex, minimum width=4.0ex, minimum height=4.0ex
	},
	arnsmall/.style={
		treenode, circle, font=\sffamily\bfseries, draw=black, fill=white, text width=1.5ex
	},
	make f/.style={
